...
function RulesPage(){
  this.render = function(){
    ...
    rulesContainer.innerHTML = '\n' +
      'At the beginning of the game, the player appears in the center of the screen. ' +
      'Crazy cosmic balls appear at the top of the screen. The goal of the game is to destroy' +
      ' the targets by pressing the space bar, moving with the help of the arrows or the keys W,A,S,D';
