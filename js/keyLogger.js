class KeyLogger {    //класс для управления игроком
...
//function KeyLogger(){  //функция-конструктор для управления игроком

//  this.keyStatus = {up:false,down:false,left:false,right:false,fire:false};
//  this.keyDownListener = function(e){  // определение кода отжатой клавиши на клавиатуре или кнопки мыши
//    let key = e.keyCode ? e.keyCode : e.which;
//    switch(key){
//
//      case 87: // клавиша "w"
...
//  };
//
//  this.keyUpListener = function(e){  // определение кода отжатой клавиши на клавиатуре или кнопки мыши
//
//    let key = e.keyCode ? e.keyCode : e.which;
//    switch(key){
//
